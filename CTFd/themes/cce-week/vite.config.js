      ...
      plugins: [
        copy({
          targets: [
            ...
            {
              src: "./node_modules/@fontsource/share-tech-mono/files/**/*400*-normal*",
              dest: "static/webfonts",
            },
            {
              src: "./node_modules/@fontsource/orbitron/files/**/*400*-normal*",
              dest: "static/webfonts",
            },
            {
              src: "./node_modules/@fontsource/orbitron/files/**/*700*-normal*",
              dest: "static/webfonts",
            },
            {
              src: "./node_modules/@fontsource/orbitron/files/**/*900*-normal*",
              dest: "static/webfonts",
            },
            {
              src: "./assets/img/**",
